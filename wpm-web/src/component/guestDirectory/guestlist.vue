  ...
  <div class="list-con">
    ...
    >
      <div class="title">
        ...
        <span class="toChanceSee" @click="gotoChance(item,'see')" v-if="item.hasSeeBus">商机 ></span>
      </div>
  ...
  methods: {
    ...
    gotoChance(item, type) {
      ...
      if (type === "see") {
        ...
        const params = `&id=${id}&visitObjectId=${visitObjectId}&otherPeople=${otherPeople}&phoneNumber=${phoneNumber}&address=${address}&visitorsRecord=${visitorsRecord}`;
